                    ...
                    @auth
                        ...
                        <a href="{{ url('/cart') }}" class="relative">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="#e6ddd1" class="w-7 h-7">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M2.25 3h1.5l1.591 9.546a2.25 2.25 0 002.239 1.954h9.84a2.25 2.25 0 002.239-1.954L21.75 6.75H6.375"/>
                            </svg>
                            <span class="absolute -top-2 -right-2 bg-[#d48c7f] text-white text-xs w-5 h-5 rounded-full flex items-center justify-center">
                                {{ $cartCount }}
                            </span>
                        </a>
